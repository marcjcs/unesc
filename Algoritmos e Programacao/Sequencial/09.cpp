...
main ()
{
	...
	if (num[2]<num[3])
	{
		printf("Ordem: %d - %d - %d - %d",num[0],num[1],num[2],num[3]);
	}
	else  if (num[3]<num[2]&&num[3]>num[1])
	{
		printf("Ordem: %d - %d - %d - %d",num[0],num[1],num[3],num[2]);
	}
	else if (num[3]<num[1]&&num[3]>num[0])
	{
		printf("Ordem: %d - %d - %d - %d",num[0],num[3],num[1],num[2]);
	}
	else 
	{
		printf("Ordem: %d - %d - %d - %d",num[3],num[0],num[1],num[2]);		
	}
	getch();
}
